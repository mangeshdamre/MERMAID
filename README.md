...
The user can see the input and output files generated by MERMAID server. All the files can be download by clicking the link <img src="https://github.com/mangeshdamre/MERMAID/blob/main/Images/tab2.png" width="150" />. User can extract the files to the local system and can perform the analysis.
<p float="center">
